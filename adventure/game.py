...
# Assuming you have a function to get a room object by its name
# for room_name in rooms_with_blobs_names:
#     room_object = get_room_by_name(room_name)
#     random_x = random.randint(50, 250)
#     random_y = random.randint(50, 250)
#     room_object.add_blob(random_x, random_y)
...
def change_door_to_walkable(self):
    # Change tiles 'd' and 'e' to 'a' (walkable tiles)
    new_tile_map = []
